...
The prologue is an opening case study, not a prerequisite. The numbered course
begins with vectors and builds toward spectral methods and the SVD. Optional
application modules appear after the core chapters.

Each numbered chapter follows the same pattern:
...
For a one-semester course, the intended core is Chapters~1--14. The optional
application modules can be used for projects, presentations, or the final weeks
of a longer course.
